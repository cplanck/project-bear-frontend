...
export const blankInstrumentObject = {name: '',id: '', serial_number:'' ,description: '',notes: '' ,instrument_color: '#4287f5', avatar: '', status: '', starred: false, starred_date: '', purchase_date: '', template: false, data_model: {configured: false, field_num: 0, entries: 0}}
